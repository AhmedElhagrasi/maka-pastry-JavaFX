...
public class OrderDateMenu {
	...
	public OrderDateMenu(String name_order, double salS_order, double salM_order, double salL_order,
			double salC_order) {
		super();
		...
		order_size.getItems().addAll(new String[] { "Small   ", "Medium  ", "Large   ", "ONE-SIZE" });
